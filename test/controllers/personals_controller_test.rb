...
class PersonalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal" do
    assert_difference('Personal.count') do
      post personals_url, params: { personal: { activo: @personal.activo, apeynom: @personal.apeynom, documento: @personal.documento, domic: @personal.domic, fecing: @personal.fecing, fecnac: @personal.fecnac } }
    end
  ...
  test "should update personal" do
    patch personal_url(@personal), params: { personal: { activo: @personal.activo, apeynom: @personal.apeynom, documento: @personal.documento, domic: @personal.domic, fecing: @personal.fecing, fecnac: @personal.fecnac } }

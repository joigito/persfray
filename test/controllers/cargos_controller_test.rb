...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post cargos_url, params: { cargo: { activo: @cargo.activo, cargo: @cargo.cargo, curso: @cargo.curso, desde: @cargo.desde, hasta: @cargo.hasta, personal_id: @cargo.personal_id } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { activo: @cargo.activo, cargo: @cargo.cargo, curso: @cargo.curso, desde: @cargo.desde, hasta: @cargo.hasta, personal_id: @cargo.personal_id } }
